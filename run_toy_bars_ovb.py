...
dataset_te = 'data/toy_bars/test.txt.npy'
data_te = np.load(dataset_te)
vocab_size = 9
#--------------convert to one-hot representation------------------
print 'Loaded data'
counts_tr = np.array(
	[helpers.onehot(doc.astype('int'),vocab_size)
...
helpers.plot_bars(topics, 'inferred_topics_ovb.png')
...
helpers.plot_bars(recreated_tr, 'recreated_docs_train_ovb.png')
...
helpers.plot_bars(recreated_te, 'recreated_docs_test_ovb.png')
...
helpers.plot_bars(recreated_te1, 'recreated_docs_test_ovb_after_inference.png')
